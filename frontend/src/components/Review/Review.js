...
export default function Review({feedback, handleAddReactionForReview, handleDeleteReview}) {
    ...
    const handleReplySubmit = async () => {
        try {
            await replyToReview(feedback.id, replyText)
        } catch (e) {
    ...
    return (
        <div className="card shadow-sm mb-3">
            <div className="card-body">
                ...
                <div className="dropdown position-absolute top-0 end-0 m-2">
                    ...
                    {menuOpen && (
                        <ul className="dropdown-menu dropdown-menu-end show">
                            ...
                            {user.id === feedback.user.id && (
                                <li>
                                    <button onClick={() => {handleDeleteReview(feedback.id)}} className="dropdown-item text-danger">
                ...
                {feedback.image && (
                    <div className="mb-3">
                        <img src={`${process.env.REACT_APP_API_BASE_URL}/${feedback.image}`} alt="Review"
